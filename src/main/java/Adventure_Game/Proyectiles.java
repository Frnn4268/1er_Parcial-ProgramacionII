...
public class Proyectiles implements Objetos_Muebles{
    
    Scanner sc = new Scanner(System.in);

    @Override
    public void NombreOM() {
        System.out.println("Ingrese el nombre del proyectil: ");
        String NombreP = sc.nextLine();
        System.out.println("El nombre del proyectil es: " + NombreP);
        System.out.println("");
    }
